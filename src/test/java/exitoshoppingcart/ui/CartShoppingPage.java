...
public class CartShoppingPage extends PageObject {
    ...
    public static final Target CONFIRM_EMAIL_BUTTON = Target.the("Confirm email input").
            located(By.className("exito-checkout-io-0-x-preLoginBlockButton"));

    public static final String PRODUCT_NAME_SHOPPING_CART = "//*[@class='exito-checkout-io-0-x-itemCartContent'])[%s]/div[1]/div[4]/span";

    public static final String PRODUCT_PRICE_SHOPPING_CART = "(//*[@class='exito-checkout-io-0-x-itemCartContent'])[%s]/div[1]/div[5]/div/span/span";
    public static final String PRODUCT_QUANTITY_SHOPPING_CART = "(//*[@class='exito-checkout-io-0-x-itemCartContent'])[%s]/div[1]/div[6]/div/div/div/div/span[1]";

    public static final Target TOTAL_PURCHASE = Target.the("Total purchase").
            located(By.xpath("(//*[@class='exito-checkout-io-0-x-summaryContainer'])/div[1]/div[2]/div[1]/span[2]"));
